...
- [X] Доступ к тестированию только при регистрации в ЛК
- [X] Отправка отформатированных сообщений с вопросами пользователю
- [X] Автоматическая интерпретация результатов заданий
  - [X] Задания 1-4
  - [X] Задание 8
- [X] Отправка расшифровок по профессиональным направлениям на основе результатов тестов
- [X] Меню с возможностью просмотра списка заданий и расшифровок к ним
- [X] Возможность через кнопку меню задать вопрос профдизайнеру
- [X] Просмотр результата тестов в админ-панели
- [X] Общая сводка по подростку с возможностью скачать в PDF
- [X] Возможность ответить на вопрос подростка в админ-панели
- [X] Уведомление профдизайнера в telegram о том, что ему пришёл вопрос от подростка
- [X] Тестирование API Django приложения
- [X] Регистрация профдизайнеров в админ-панели
