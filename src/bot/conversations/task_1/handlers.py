...
TASK_ONE_DESCRIPTION = (
    ...
    " Распредели предлагаемые утверждения в каждом вопросе по степени привлекательности"
    " (от самого привлекательного варианта до самого непривлекательного варианта)."
)
