    ...
    def test_sorted_scales_in_non_growing_order(self):
        ...
        test_scale_scores_counters = {
            'all_scores_different': {
                'scale_2': 8, 'scale_5': 9, 'scale_4': 10,
                'scale_6': 4, 'scale_1': 6, 'scale_3': 5
            },
            'some_scores_equals': {
                'scale_4': 8, 'scale_1': 10, 'scale_3': 3,
                'scale_2': 8, 'scale_6': 9, 'scale_5': 4
            },
            'all_scores_equals': {
                'scale_5': 7, 'scale_2': 7, 'scale_1': 7,
                'scale_3': 7, 'scale_4': 7, 'scale_6': 7
            }
        }
        expected = [
            [('scale_4', 10), ('scale_5', 9), ('scale_2', 8),
             ('scale_1', 6), ('scale_3', 5), ('scale_6', 4),],
            [('scale_1', 10), ('scale_6', 9), ('scale_2', 8),
             ('scale_4', 8), ('scale_5', 4), ('scale_3', 3),],
            [('scale_1', 7), ('scale_2', 7), ('scale_3', 7),
             ('scale_4', 7), ('scale_5', 7), ('scale_6', 7),],
        ]
    ...
    def test_make_top_scales_by_scores(self):
        ...
        test_scale_scores_counters = {
            '3_leaders': [
                ...
                ('scale_4', 6), ('scale_2', 5), ('scale_6', 4),
            ],
            '4 leaders': [
                ('scale_1', 10), ('scale_3', 9), ('scale_2', 8),
                ('scale_6', 8), ('scale_4', 4), ('scale_5', 3),
            ],
            'all_scores_equals': [
                ('scale_1', 7), ('scale_2', 7), ('scale_3', 7),
                ('scale_4', 7), ('scale_5', 7), ('scale_6', 7),
