...
class UserTests(APITestCase):
    ...
    def test_create_tg_user(self):
        ...
        self.assertEqual(
            count_of_users_before + 1, UserFromTelegram.objects.count()
        )
    ...
    def test_patch_tg_user(self):
        ...
        modified_user = UserFromTelegram.objects.get(
            telegram_id=new_user_tg_id
        )
    ...
    def test_requests_chain_tg_user(self):
        ...
        new_user_url = self._get_detail_user_url(
            expected_response_data['telegram_id']
        )
